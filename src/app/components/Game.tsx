...
export default function Game() {
  ...
  const [buttonPosition, setButtonPosition] = useState({ top: "21.6%", left: "70%" });
  ...
  if (showTransition) {
    return (
      <div className="w-96 h-96 flex flex-col items-center justify-center">
        <h1 className="text-2xl font-bold">Parabéns! Você acertou a palavra!</h1>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-blue-100">
      <div className="flex flex-col items-center">
        ...
        />
        <div className="mt-8">
          <p className="text-lg font-bold">Pontuação atual da fase: {phaseScore}</p>
